function esVerdaderoYFalso(booleano1, booleano2) {
  ...
  // Tu código:
  if(booleano1==='verdadero' && booleano1===booleano2)console.log(true)
    else console.log(false)
}

esVerdaderoYFalso('verdadero', 'verdadero');

esVerdaderoYFalso('verdadero', 'falso');

esVerdaderoYFalso('falso', 'falso');
